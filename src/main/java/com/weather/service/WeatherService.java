...
public class WeatherService {
    ...
    public String handleMessageSubmission(@RequestParam String message, 
                                          @RequestParam double latitude, 
                                          @RequestParam double longitude, 
                                          Model model) {
        // Process the message, latitude, and longitude
        String messageData = String.format("Message: %s, Coordinates: (%f, %f)", message, latitude, longitude);
        
        // Add the message data to the model to be displayed on the page or logged
        model.addAttribute("messageData", messageData);
        System.out.println(messageData);
        
        // You can redirect or return a view that will display the processed message
        return "confirm"; // Redirect to confirmation page or show on the same page
    }
